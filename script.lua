...
local Astra = Instance.new("TextLabel")
...
Frame12.Size = UDim2.new(0, 335, 0, 182)
...
SoftAimText.Size = UDim2.new(0, 65, 0, 26)
...
local function JBPL_fake_script() -- Astra.LocalScript 
	local script = Instance.new('LocalScript', Astra)

	while true do
		for a = 1,360,1 do
			wait(0.1)
			Astra.TextColor3 = Color3.fromHSV(a/360,1,1)
		end
	end
end
